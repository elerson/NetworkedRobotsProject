...
class Robot:
    ...
    def control(self):
        ...
        ##
        ###
        robot_as_obstacles = self.robotAsObstacles(0.70, gamma)
        robot_as_obstacles = (robot_as_obstacles[0], -robot_as_obstacles[1])
        robot_as_obstacles = (0, 0)


        if( not closest_point_seg_allocation[0] == closest_point_seg_allocation[1]):
            final_direction = (beta*tree_direction[0] + alpha*direction_to_segment[0] + robot_as_obstacles[0], beta*tree_direction[1] + alpha*direction_to_segment[1] + robot_as_obstacles[1])
        else:
            final_direction = (beta*tree_direction[0] + d1_f[0] + d2_f[0] + robot_as_obstacles[0], beta*tree_direction[1] + d1_f[1] + d2_f[1] + robot_as_obstacles[1])
